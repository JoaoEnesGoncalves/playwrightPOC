...
test.beforeAll(async () => {
  ...
  Batch = new BatchInfo({ name: 'POC Grid' });
  ...
  Config.addBrowser(viewportWidth, viewportHeight, BrowserType.CHROME_ONE_VERSION_BACK);
  Config.addBrowser(viewportWidth, viewportHeight, BrowserType.FIREFOX);
  Config.addBrowser(viewportWidth, viewportHeight, BrowserType.SAFARI);
  Config.addBrowser(viewportWidth, viewportHeight, BrowserType.EDGE_LEGACY);
});
