...
module.exports = {
    default: [
        ...
        `--require "./Pentaho/tests/features/*.steps.ts"`,     // load step definition libraries
        `--require './Pentaho/tests/features/*.config.ts'`     // load configuration files, such as features/support/
    ].join(' ')
};
